(() => {
    ...
    const initializeProjects = () => {
        ...
        // Garante que o navegador tenha um frame para aplicar o estado inicial
        // antes de liberar a animação de entrada.
    ...
    const existingStylesheet = document.querySelector('link[data-projects-v2]');
    ...
    stylesheet.onload = initializeProjects;
    stylesheet.onerror = initializeProjects;
